        ...
        <div className="container login">
            ...
            <Form>
                <Form.Group controlId="formBasicEmail">
                    <input type="text" placeholder="Почта или телефон" className="login__password-wrap__password p-3" />
                </Form.Group>
                <Form.Group controlId="formBasicEmail">
                    ...
                    <div className="login__password-wrap">
                        <input
                            ...
                            type="password"
                            placeholder="Пароль"
                            className="login__password-wrap__password"
                        />
                        <svg
                ...
                <div className="login__wrong-auth">
                    Не правильный логин или пароль. <br/> Попробуйте ещё раз, а в крайнем случае напишите администратору:
                    hvost@soroka.app
                </div>
            </Form>
        </div>
