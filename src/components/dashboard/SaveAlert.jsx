        ...
        <div className="save-alert">
            ...
            <button className="dashboard-button" disabled={isUserNotChangedProperties}>
                <svg width="26" height="24" viewBox="0 0 26 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    />
                    <rect x="8.1517" y="13" width="10.3971" height="8" stroke="black" stroke-linejoin="round" />
                    <rect x="9.19141" y="3" width="8.31769" height="5" stroke="black" stroke-linejoin="round" />
                </svg>
                <span>Сохранить</span>
            </button>
        </div>
